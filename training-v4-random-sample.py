...
OUTPUT_DIR = f"./IFMF-{BASE_MODEL}-v4-Full-RSQ"
...
def generate_training_examples(row):
    ...
    # Example 1: Standard recipe request variations - randomly select 2 variations
    recipe_request_variations = random.sample([
...
- Jangan lupa cicipi sebelum disajikan"""
    ...
    # Example 2: Simple recipe questions - randomly select 3 variations
    simple_questions = random.sample([
...
Selamat mencoba!"""
    ...
    # Example 3: Ingredient-based recommendation - randomly select 2 variations if enough ingredients
    if len(ingredient_list) >= 3:
        ...
        ingredient_questions = random.sample([
...
- Ikuti langkah-langkah dengan teliti"""
    ...
    # Example 4: Ingredient inquiry - randomly select 1 variation if ingredients exist
    if ingredient_list:
        main_ingredient = random.choice(ingredient_list)
        ingredient_inquiry_variations = random.sample([
